        ...
        <div className=" p-2 float-right" style={{width: "60%", marginRight:"13.313rem"}}>
          <div className=" w-full lg:max-w-full lg:flex">
            <div
              ...
              title="Mountain"
            ></div>
            <div style={{backgroundColor:"#fffffc"}} className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
              <div className="mb-8">
