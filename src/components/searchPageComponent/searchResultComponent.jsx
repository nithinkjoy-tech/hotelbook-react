       ...
       <div key={hotel.name} className="maghny-gd-1 col-lg-4 col-md-6 mt-md-5 mt-4">
                <div className="maghny-grid">
                    <figure className="effect-lily">
                        ...
                        <figcaption>
                            <div>
                                <h4 className="top-text">{hotel.name}
                    ...
                    <div className="room-info">
                        <h3 className="room-title"><a href="#url">{hotel.name}</a></h3>
                        <ul className="mb-3">
                            <li key={hotel.guests}><span className="fa fa-users"></span>{hotel.guests} Guests</li>
                            <li key={hotel.roomSize}><span className="fa fa-bed"></span> {hotel.roomSize}sqft</li>
                        </ul>
                        ...
                        <div className="room-info-bottom">
                            <ul className="room-amenities">
                                ...
                                <li><a href="#url"><span className="fa fa-television" title="Television"></span></a></li>
                                <li><a href="#url"><span className="fa fa-bath" title="Private Bathroom"></span></a></li>
                            </ul>
