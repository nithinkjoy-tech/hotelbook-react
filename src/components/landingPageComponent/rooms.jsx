            ...
            <div className="maghny-grid">
              ...
              <div className="room-info">
                <h3 className="room-title">
                  <a href="room-single.html">Luxury Hotel</a>
                </h3>
                <ul className="mb-3">
                  <li>
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. A recusandae, illum sequi
                  numquam tempora voluptates?
                </p>
                <a href="#book" className="btn btn-style btn-primary mt-sm-4 mt-3">
                  Book Now
                </a>
              </div>
            </div>
