            ...
            <div className="row">
              ...
              <div className="col-lg-6 mt-lg-0 mt-5 about-right-faq align-self">
                ...
                <ul className="w3l-right-book mt-4">
                  <li>
                    <span className="fa fa-check" aria-hidden="true"></span>We make the best for all
                    our customers
                  </li>
                  <li>
                    <span className="fa fa-check" aria-hidden="true"></span>Follow our Resort Luxury
                    Hotels
                  </li>
                  <li>
                    <span className="fa fa-check" aria-hidden="true"></span>Double rooms and family
                    rooms
                  </li>
                  <li>
                    <span className="fa fa-check" aria-hidden="true"></span>Enjoy a luxury
                    experience
                  </li>
                </ul>
